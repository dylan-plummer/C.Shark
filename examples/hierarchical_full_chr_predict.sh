...
python hierarchical_full_chr_predict.py \
  --model "/mnt/jinstore/JinLab02/dmp131/C.Shark/checkpoints/mESC_hierarchical_64bp.ckpt" \
  --out "outputs/chr19_rad21_ko_results.tsv" \
  --chrom "chr19" \
  --assembly "mm10" \
